...
$notAwakenedComputersTable = $results |
Where-Object { -not $_.Awake } |
Select-Object @{Name = 'Computer Name'; Expression = { $_.ComputerName } } |
ConvertTo-Html -Fragment

# Update error computers table
$updateErrorComputersTable = $results |
Where-Object { $_.Awake -and $_.UpdateError } |
Select-Object @{Name = 'Computer Name'; Expression = { $_.ComputerName } } |
ConvertTo-Html -Fragment
